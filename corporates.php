...
$array = [
    ...
    ['id' => 'pr1', 'db_id'=>'TEDS_3291647','source'=>'dataTed','name' =>'Pricewaterhousecoopers', 'core'=> 2, 'coreName'=>'PRICEWATERHOUSECOOPERS'] ,
    ['id' => 'pr2', 'db_id'=>'TEDS_2086900','source'=>'dataTed','name' =>'PriceWaterhouseCoopers', 'core'=> 2, 'coreName'=>'PRICEWATERHOUSECOOPERS'], 
    ['id' => 'pr3', 'db_id'=>'TEDS_3182742','source'=>'dataTed','name' =>'Pricewaterhousecoopers', 'core'=> 2, 'coreName'=>'PRICEWATERHOUSECOOPERS'], 
    ['id' => 'pr4', 'db_id'=>'TEDS_2326952','source'=>'dataTed','name' =>'PricewaterhouseCoopers LLP', 'core'=> 2, 'coreName'=>'PRICEWATERHOUSECOOPERS'], 
    ['id' => 'pr5', 'db_id'=>'TEDS_3121459','source'=>'dataTed','name' =>'PricewaterhouseCoopers LLP', 'core'=> 2, 'coreName'=>'PRICEWATERHOUSECOOPERS'], 
    ['id' => 'pr6', 'db_id'=>'TEDS_2708423','source'=>'dataTed','name' =>'PricewaterhouseCoopers LLP', 'core'=> 2, 'coreName'=>'PRICEWATERHOUSECOOPERS'], 
    ['id' => 'pr7', 'db_id'=>'TEDS_2851400','source'=>'dataTed','name' =>'PricewaterhouseCoopers LLP', 'core'=> 2, 'coreName'=>'PRICEWATERHOUSECOOPERS'], 
    ['id' => 'pr8', 'db_id'=>'TEDS_2204463','source'=>'dataTed','name' =>'PricewaterhouseCoopers LLP', 'core'=> 2, 'coreName'=>'PRICEWATERHOUSECOOPERS'],
    ['id' => 'pr9', 'db_id'=>'TEDS_2088190','source'=>'dataTed','name' =>'PricewaterhouseCoopers LLP', 'core'=> 2, 'coreName'=>'PRICEWATERHOUSECOOPERS'],
    ['id' => 'pr10', 'db_id'=>'54003311617','source'=>'dataAustralia','name' =>'PRICEWATERHOUSE COOPERS SECURITIES LTD ', 'core'=> 2, 'coreName'=>'PRICEWATERHOUSECOOPERS'],
    ['id' => 'pr11', 'db_id'=>'094496049','source'=>'dataDiaugeia','name' =>'PRICEWATERHOUSECOOPERS BUSINESS SOLUTIONS ΑΝΩΝΥΜΗ ΕΤΑΙΡΕΙΑ ΠΑΡΟΧΗΣ ΕΠΙΧΕΙΡΗΜΑΤΙΚΩΝ ΚΑΙ ΛΟΓΙΣΤΙΚΩΝ||PRICEWATERHOUSECOOPERS BUSINESS SOLUTIONS AE', 'core'=> 2, 'coreName'=>'PRICEWATERHOUSECOOPERS'],
    ['id' => 'pr12', 'db_id'=>'997802310','source'=>'dataDiaugeia','name' =>'PRICEWATERHOUSECOOPERS ACCOUNTING ΑΝΩΝΥΜΗ ΕΤΑΙΡΕΙΑ ΠΑΡΟΧΗΣ ΛΟΓΙΣΤΙΚΩΝ ΥΠΗΡΕΣΙΩΝ||PRICEWATERHOUSECOOPERS ACCOUNTING ΑΕ', 'core'=> 2, 'coreName'=>'PRICEWATERHOUSECOOPERS'],
    ...
    ['id' => 'at19', 'db_id'=>'094035050','source'=>'dataGemh','name' =>'ATOS IT SERVICES YΠΗΡΕΣΙΕΣ ΠΛΗΡΟΦΟΡΙΚΗΣ ΚΑΙ ΤΗΛΕΠΙΚΟΙΝΩΝΙΩΝ ΑΝΩΝΥΜΗ ΕΤΑΙΡΕΙΑ ', 'core'=> 4, 'coreName'=>'ATOS'],
    ['id' => 'at20', 'db_id'=>'800336879','source'=>'dataGemh','name' =>'(ΥΠΟ ΕΚΚΑΘΑΡΙΣΗ)ATOS Accounting and Tax Outsourcing Ανώνυμη Εταιρία Συμβουλευτικών Υπηρεσιών ', 'core'=> 4, 'coreName'=>'ATOS'],
    ['id' => 'at21', 'db_id'=>'83401687977','source'=>'dataAustralia','name' =>'ATOS AUSTRALIA PTY LTD', 'core'=> 4, 'coreName'=>'ATOS'],
