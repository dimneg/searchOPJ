						...
						<select name="advSearch[search_in_amount]" id="search_in_amount" class="demoInputBox">
							...
							<option value="2" <?php if($search_in_amount=="2") { echo "selected"; } ?>> >2Κ <2M </option>
                                 ...
                                 <div> <input type="submit" name="Go" class="btnSearch"  value="Search" action="index.php?varKeyword=<?php if (isset($_POST['formKeyword'])) echo $_POST['formKeyword'];  else echo $_GET['varKeyword']?>">
                                     <input type="button" value="Search" class="btnSearch" onclick="index.php?varKeyword=<?php if (isset($_POST['formKeyword'])) echo $_POST['formKeyword'];  else echo $_GET['varKeyword']?>" />
