...
class results {
   # function __construct($langBlgls){ // 
    #    $this->$langBlgl = $langBlgls;
    #}
    ...
    function showResults(){
        ...
        if (strpos($Actual_link,'/en/') !== false) {
         ...
         else if (strpos($Actual_link,'/el/') !== false) {
           $Lang= 'el/';
         }
else $Lang = '';
...
if  	(strpos($link,'diaugeia/org') !== false)   { //διαυγεια 035970655
	...
	//echo "<a href='".$nameLink."'target='_blank'  > <B>Στη DIAVGEIA</B></a> </br>";
	//echo '<B>';
    ...
    if ((isset($link4)) && ($link4 !== ' ')) {	//missing buyer for 099360290
		//echo $link4."</br>";
		//echo "<a href='".$nameLink."'target='_blank'  > <B>Στη DIAVGEIA</B></a> </br>"; //use namelink for superprofile
		//echo "<a href='".$link4."'target='_blank' fontcolor='#FFA500' size='1' > <B>Φορέας </B></a> ";
		echo "<a href='".$link4."'target='_blank' style='font-size: 10px; color: #FFA500;'  <B>BUYER</B> </a> ";
		...
		echo  ' &nbsp [until '.$uniqueResults[$i]['lastUpdateEDB'].']</br>';
	    }
    ...
    if ((isset($link2)) && ($link2 !== ' ')){	
	    ...
	    echo  ' &nbsp [until '.$uniqueResults[$i]['lastUpdateEDS'].']</br>';			
        }		
    $link3 = $uniqueResults[$i]['linkEKS'];   
    if ((isset($link3)) && ($link3 !== ' ')) {	
		//echo $link3."</br>";
		//echo "<a href='".$nameLink."'target='_blank'  > <B>Στo E-PROCUREMENT</B></a> </br>";
	    ...
	    echo  ' &nbsp [until '.$uniqueResults[$i]['lastUpdateEKS'].']</br>';	
	    }
	}
	else
    ...
    if ((isset($link4)) && ($link4 !== ' ')) {	//test for missing seller, works
		//echo $link4."</br>";
		//echo "<a href='".$nameLink."'target='_blank'  > <B>Στη DIAVGEIA</B></a> </br>"; //use namelink for superprofile
		echo "<a href='".$link4."'target='_blank' style='font-size: 10px; color: #FFA500;'  <B>SELLER</B> </a> ";
		//echo ' <font color="#FFA500" size="1">Ανάδοχος</font> '; 
		echo  'Finalized: ';               
			$sumSpend = $this->fromTextToNumber($uniqueResults[$i]['spend0EDS']) + $this->fromTextToNumber($uniqueResults[$i]['spend1EDS']) + $this->fromTextToNumber($uniqueResults[$i]['spend2EDS'])  ;
		echo '<B> '.  $this->fromNumberToText($sumSpend,'€').'</B>';
    ...
    if ((isset($link3)) && ($link3 !== ' ')) {	
	    ...
	    echo  ' &nbsp [until '.$uniqueResults[$i]['lastUpdateEKB'].']</br>';	
	    }
	...
	if (($uniqueResults[$i]['pageKind']) =='buyerDiavgeia'){ //eg 017130241 χανουμε τον seller (buyerdiaugeia ενω εχει seller) δεν δουλεύει 018133333 + double problem
	  //  echo "<a href='".$nameLink."'target='_blank'  > <B>Στη DIAVGEIA</B></a> </br>"; //use namelink for superprofile
		...
		//echo $link4."</br>";
		//echo "<a href='".$nameLink."'target='_blank'  > <B>Στη DIAVGEIA</B></a> </br>"; //use namelink for superprofile
		echo "<a href='".$link2."'target='_blank' style='font-size: 10px; color: #FFA500;'  <B>SELLER</B> </a> ";
		//echo ' <font color="#FFA500" size="1">Ανάδοχος</font> '; 
		echo  'Finalized: ';               
			$sumSpend=  $this->fromTextToNumber($uniqueResults[$i]['spend0EDS']) + $this->fromTextToNumber($uniqueResults[$i]['spend1EDS']) + $this->fromTextToNumber($uniqueResults[$i]['spend2EDS'])  ;
		echo '<B> '.  $this->fromNumberToText($sumSpend,'€').'</B>';
	...
	if (($uniqueResults[$i]['pageKind']) =='buyerKhmdhs'){ //eg 090034024 buyerKhmdhs αλλα έχει και διαυγεια fixed
		...
		echo ' <font class="dataset" color="#006621" style="font-size: 0.77em">DIAVGEIA</font></br> ';
		//echo "<a href='".$link2."'target='_blank'  > <B>Στη DIAVGEIA</B></a> </br>"; 
		//echo '<B>';
		echo ' <font color="#FFA500" size="1">BUYER</font> '; 
		//echo '</B>';
		echo  'Finalized: ';               
	...
	echo  ' &nbsp [until '.$this->convertDate($uniqueResults[$i]['lastUpdate']).']</br>';
	...
	echo 'V.A.T. '.$this->hide_not_avail($uniqueResults[$i]['vat']."</br>");
	echo '</I>';
	//echo  '<B>ΣΤΗ DIAVGEIA<sup><font size="1">BUYER</font></sup> :  </B>'; 
	//echo  '<B>ΣΤΗ DIAVGEIA :  </B>';
	//echo 'Στη ';
	//echo "<a href='".$nameLink."'target='_blank' > <B>Στη DIAVGEIA</B></a> </br>";
	echo ' <font class="dataset" color="#006621" style="font-size: 0.77em">DIAVGEIA</font></br> '; 
	//echo '<B> ';
	echo ' <font color="#FFA500" size="1">BUYER&nbsp </font> '; 
    //	echo '</B> ';
	echo  'Finalized: ';
		  $sumSpend=
   ...
   // echo '<sup><font size="2">SELLER: </font></sup>';
    //echo '<B> ';
	echo ' <font color="#FFA500" size="1">SELLER&nbsp </font> ';
    //echo ' <font color="#006621" font  size="1">SELLER&nbsp </font> '; 	
	//echo '</B> ';
	echo  'Finalized: ';
		  $sumSpendSel=
	...
	//echo "<a href='".$link2."'target='_blank'  > <font  <B>Στο E-PROCUREMENT</B></font> </a> </br>";
	echo ' <font class="dataset" color="#006621" style="font-size: 0.77em">E-PROCUREMENT</font></br> '; 
	//echo '<sup><font size="2">BUYER: </font></sup>';
	//echo '<B> ';
	echo ' <font color="#FFA500" size="1">BUYER&nbsp </font> '; 
	//echo ' <font color="#006621" size="1">BUYER&nbsp </font> '; 
	//echo '</B> ';
	echo  'Contracts: ';
		...
		echo  ' &nbsp [until '.$uniqueResults[$i]['lastUpdateHKB'].']<br>';	
	}
	...
	//echo 'Στο ';
	echo ' <font class="dataset" color="#006621" style="font-size: 0.77em">E-PROCUREMENT</font></br> '; 
	//echo "<a href='".$link3."'target='_blank' > <B>Στο E-PROCUREMENT</B></a> </br>";
	//echo '<B> ';
	echo ' <font color="#FFA500" size="1">SELLER&nbsp </font> '; 
	//echo ' <font color="#006621" size="1">SELLER&nbsp </font> '; 
	//echo '</B> ';
	//echo  '<B>E-PROCUREMENT<sup><font size="1">SELLER</font></sup> :  </B>'; 
	...
	echo  'Contracts: ';
		...
		echo  ' &nbsp [until '.$uniqueResults[$i]['lastUpdateHKS'].']<br>';
	}
	
	//echo  '<B>E-PROCUREMENT<sup><font size="1">SELLER</font></sup> :  </B><br>'; 
	...
	//echo  '<B>'.(getSource($link,'d')).'<sup><font size="1">'.$property.'</font></sup> :  </B>'; //DIAVGEIA
		...
		//echo "<a href='".$nameLink."'target='_blank'  > <B>Στη DIAVGEIA - E-PROCUREMENT</B></a> </br>";
		//echo "<a href='".$nameLink."'target='_blank'  > <B>Στη DIAVGEIA</B></a> </br>";
		echo ' <font class="dataset" color="#006621" style="font-size: 0.77em">DIAVGEIA</font></br> '; 
		//echo '<B>';
	    echo ' <font color="#FFA500" size="1">'.$property.'</font> '; 
		...
		//echo "<a href='".$nameLink."'target='_blank'  > <font  <B>Στο E-PROCUREMENT</B></font> </a> </br>";
		//echo ' <font color="#FFA500" size="1">'.$property.'</font> '; 
		//echo "<a href='".$nameLink."'target='_blank'  > <B>Στη DIAVGEIA</B></a> </br>";
		echo ' <font class="dataset" color="#006621" style="font-size: 0.77em">DIAVGEIA</font></br> '; 
		//echo '<B>';
		...
		echo  ' &nbsp [until '.$uniqueResults[$i]['lastUpdate_2'].']<br>';
		}
	...
	//echo  '<B>'.(getSource($link,'k')).'<sup><font size="1">'.$property.'</font></sup> :  </B>'; //KHMDHS
		...
		echo  ' &nbsp [until '.$uniqueResults[$i]['lastUpdate_2'].']';	
	    echo "</td>";
		}
 }	
...
echo "<td style=\" text-align:left; border-left: 0px solid #ccc; font-size:15px; padding-right:0px;  width:400px;\">";
	...
	echo ' <font class="dataset" color="#006621" style="font-size: 0.75em">PRICES OBSERVATORY-Product</font></br> '; 
	//echo '</B>';
	//echo '<B>';
	//echo ' <font color="#FFA500" size="1">ΠΡΟΙΟΝ</font></br> '; 
	//echo '</B>';
	echo '<font color="#FFA500" style="font-size: 0.80em">Average 2015&nbsp</font> ';
	echo '<B>';
	echo $uniqueResults[$i]['average'];	
	echo '</B>';
	echo '&nbsp';
	echo '<font color="#FFA500" style="font-size: 0.80em">Price difference 2015&nbsp</font> ';
	echo '<B>';
	echo $uniqueResults[$i]['variationPrice'];	
	echo '</B>';
	echo '</br>';
	echo '<font color="#FFA500" style="font-size: 0.80em">min 2015&nbsp</font> ';
	echo '<B>';	
	...
	echo '</br>';
	echo '<font color="#FFA500" style="font-size: 0.80em">max 2015&nbsp</font> ';
	echo '<B>';
	...
	echo '</br>'; 
	echo  '[';
	echo '<font  style="font-size: 0.80em">Last update&nbsp</font> ';
	...
	echo ' <font class="dataset" color="#006621" style="font-size: 0.75em">CENTRAL MARKET OF THESSALONIKI-Product</font></br> '; 
	//echo '</B>';
	//echo '<B>';
	//echo ' <font color="#FFA500" size="1">ΠΡΟΙΟΝ</font></br> '; 
	//echo '</B>';
	echo '<font color="#FFA500" style="font-size: 0.80em">Dominant price&nbsp</font> ';
	echo '&nbsp';
	echo '<B>';
	echo $uniqueResults[$i]['dominantPriceDetails'].' €/'.$uniqueResults[$i]['unitOfMeasurement'];	
	echo '</B>';
	echo '&nbsp';
	echo '<font color="#FFA500" style="font-size: 0.80em">Week dominant&nbsp</font> ';	
	echo '&nbsp';
	echo '<B>';
	echo $uniqueResults[$i]['weekDominantPriceDetails'].' €/'.$uniqueResults[$i]['unitOfMeasurement'];	
	echo '</B>';
	echo '</br>';
	echo '<font color="#FFA500" style="font-size: 0.80em">Year dominant&nbsp</font> ';	
	echo '&nbsp';
	echo '<B>';	
	echo $uniqueResults[$i]['yearDominantPriceDetails'].' €/'.$uniqueResults[$i]['unitOfMeasurement'];		
	echo '</B>';
	echo '&nbsp';
	echo '<font color="#FFA500" style="font-size: 0.80em">Quantity&nbsp</font> ';	
	echo '&nbsp';
	echo '<B>';	
	...
	$psName=  $this->Unaccent($psName);
	echo "<a class='nameLink' href='".$nameLink."'target='_blank' >$psName</a> </br>";	
	echo ' <font class="dataset" color="#006621" style="font-size: 0.77em">PRICES OBSERVATORY-Shop</font></br> '; 
	//echo '<B>';
	//echo "<a href='".$nameLink."'target='_blank' >Στο ΠΑΡΑΤΗΡΗΤΗΡΙΟ ΤΙΜΩΝ</a> </br>";
	//echo '</B>';
	//echo '<B>';
	...
	//echo '</B>';
    //echo 'Πλήθος Ειδών ';
	echo '<font color="#FFA500" style="font-size: 0.80em">Products&nbsp</font> ';
	echo '<B>';
	echo $uniqueResults[$i]['countOfProducts'];	
	echo '</B>';
	echo '&nbsp';
	echo '<font color="#FFA500" style="font-size: 0.80em">Categories&nbsp</font> ';
	echo '<B>';
	echo $uniqueResults[$i]['countOfCategories'];	
	echo '</B>';
	echo '</br>'; 
	echo '<font color="#FFA500" style="font-size: 0.80em">Max price&nbsp</font> ';
	echo '<B>';
	...
	echo '</br>';
	echo '<font color="#FFA500" style="font-size: 0.80em">Min price&nbsp</font> ';
	echo '<B>';
	...
	echo '&nbsp';
	echo '<B>';
	echo '<font color="#FFA500" style="font-size: 0.80em">Average 2016&nbsp</font> ';
	echo '</B>';	
	echo '<B>';
	echo $uniqueResults[$i]['average'];	
	echo '</B>';
	echo '&nbsp';
	echo '<B>';
	echo '<font color="#FFA500" style="font-size: 0.80em">Price difference 2016&nbsp</font> ';
	echo '</B>';		
	echo '<B>';
	echo $uniqueResults[$i]['variationPrice'];	
	echo '</B>';
	echo '</br>';
	echo '<B>';
	echo '<font color="#FFA500" style="font-size: 0.80em">min 2016&nbsp</font> ';
	echo '</B>';	
	echo '<B>';	
	...
	echo '</br>';
	echo '<B>';
	echo '<font color="#FFA500" style="font-size: 0.80em">max 2016&nbsp</font> ';
	echo '</B>';		
	echo '<B>';
